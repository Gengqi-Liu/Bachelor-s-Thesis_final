...
\begin{figure}[t]
    ...
    \caption{Short cyclic prefix ($N_{\mathrm{FFT}}=128$, $N_{\mathrm{g}}=32$): dispersed constellation cloud despite reliable decoding (BER $\approx 0$).}
...
\begin{figure}[t]
    ...
    \caption{Low transmit amplitude ($N_{\mathrm{FFT}}=128$, $N_{\mathrm{g}}=256$): constellation clusters contract toward the origin, consistent with reduced SNR and MMSE regularization.}
