...
An appropriate choice of subcarrier spacing ensures orthogonality among the subcarriers. Let $T_{\mathrm{s}}$ denote the useful OFDM symbol duration. The subcarrier spacing is then defined as
\begin{equation}
\Delta f = \frac{1}{T_{\mathrm{s}}}.
\end{equation}
...
\begin{equation}
Y_{r,tz  }[k] = H_{r,t}[k]\,X_{\mathrm{p}}[k] + N_{r,t}[k].
\end{equation}
